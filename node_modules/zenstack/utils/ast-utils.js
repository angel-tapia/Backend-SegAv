...
exports.findUpAst = exports.getRecursiveBases = exports.getModelFieldsWithBases = exports.getContainingDataModel = exports.isCollectionPredicate = exports.getAllDataModelsIncludingImports = exports.getAllDeclarationsIncludingImports = exports.resolveImport = exports.resolveTransitiveImports = exports.resolveImportUri = exports.getDataModelFieldReference = exports.isFutureInvocation = exports.isAuthInvocation = exports.getIdFields = exports.mergeBaseModel = exports.extractDataModelsWithAllowRules = void 0;
...
function mergeBaseModel(model, linker) {
    const buildReference = linker.buildReference.bind(linker);
    model.declarations.filter(ast_1.isDataModel).forEach((decl) => {
        ...
        if (bases.length > 0) {
            ...
            // fix $containerIndex
            (0, langium_1.linkContentToContainer)(dataModel);
        }
...
function getRecursiveBases(dataModel, includeDelegate = true) {
    ...
    dataModel.superTypes.forEach((superType) => {
        ...
        if (baseDecl) {
            if (!includeDelegate && (0, sdk_1.isDelegateModel)(baseDecl)) {
                return;
            }
