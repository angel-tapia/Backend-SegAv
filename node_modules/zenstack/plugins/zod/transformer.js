...
class Transformer {
    ...
    generateEnumSchemas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.sourceFiles.push(this.project.createSourceFile(path_1.default.join(Transformer.outputPath, `enums/index.ts`), this.enumTypes
                .map((enumType) => `export * from './${(0, upper_case_first_1.upperCaseFirst)(enumType.name)}.schema';`)
                .join('\n'), { overwrite: true }));
        });
    }
...
export const ${this.name}ObjectSchema: SchemaType = ${schema} as SchemaType;`;
    ...
    generateImportPrismaStatement(options) {
        const prismaClientImportPath = (0, prisma_1.getPrismaClientImportSpec)(path_1.default.resolve(Transformer.outputPath, './objects'), options);
