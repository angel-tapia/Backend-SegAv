...
export default class Transformer {
    ...
    generatePrismaStringLine(field: PrismaDMMF.SchemaArg, inputType: PrismaDMMF.InputTypeRef, inputsLength: number): string;
    ...
    generateInputSchemas(options: PluginOptions): Promise<void>;
