        ...
        if (rootCst) {
            ...
            if (container && container.$cstNode) {
                ...
                if (fieldAstNode.type.array) {
                    // post Post[]
                    const idField = (0, ast_utils_1.getModelFieldsWithBases)(container).find((f) => f.attributes.find((attr) => { var _a; return ((_a = attr.decl.ref) === null || _a === void 0 ? void 0 : _a.name) === '@id'; }));
                    ...
                    if (!(0, ast_utils_1.getModelFieldsWithBases)(oppositeModel).find((f) => f.name === referenceIdFieldName)) {
