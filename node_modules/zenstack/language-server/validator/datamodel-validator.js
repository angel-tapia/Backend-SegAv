...
class DataModelValidator {
    validate(dm, accept) {
        ...
        (0, utils_2.validateDuplicatedDeclarations)(dm, (0, ast_utils_1.getModelFieldsWithBases)(dm), accept);
        this.validateAttributes(dm, accept);
        this.validateFields(dm, accept);
    }
    validateFields(dm, accept) {
        const allFields = (0, ast_utils_1.getModelFieldsWithBases)(dm);
    ...
    isSelfRelation(field, relationName) {
        ...
        if (relationName) {
            ...
            if (oppositeModel) {
                const oppositeModelFields = (0, ast_utils_1.getModelFieldsWithBases)(oppositeModel);
    ...
    validateRelationField(contextModel, field, accept) {
        ...
        let oppositeFields = (0, ast_utils_1.getModelFieldsWithBases)(oppositeModel, false).filter((f) => { var _a, _b; return ((_b = (_a = f.type.reference) === null || _a === void 0 ? void 0 : _a.ref) === null || _b === void 0 ? void 0 : _b.name) === contextModel.name; });
