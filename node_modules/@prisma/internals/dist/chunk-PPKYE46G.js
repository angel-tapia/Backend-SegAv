...
var chunk_PPKYE46G_exports = {};
__export(chunk_PPKYE46G_exports, {
...
module.exports = __toCommonJS(chunk_PPKYE46G_exports);
...
function lintSchema({ schema }) {
  const lintResult = import_chunk_CHY6NJBA.prismaSchemaWasm.lint(schema);
