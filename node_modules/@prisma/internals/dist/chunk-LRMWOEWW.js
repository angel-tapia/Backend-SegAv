...
var chunk_LRMWOEWW_exports = {};
__export(chunk_LRMWOEWW_exports, {
...
module.exports = __toCommonJS(chunk_LRMWOEWW_exports);
var import_chunk_EUTJYQDW = require("./chunk-EUTJYQDW.js");
var import_chunk_IPKE37QC = require("./chunk-IPKE37QC.js");
var import_chunk_AZ66WJ3B = require("./chunk-AZ66WJ3B.js");
var import_chunk_RGLQVRDT = require("./chunk-RGLQVRDT.js");
var import_chunk_R5QZ4HCI = require("./chunk-R5QZ4HCI.js");
var import_chunk_2V53YI7V = require("./chunk-2V53YI7V.js");
var import_chunk_X3P4J7WW = require("./chunk-X3P4J7WW.js");
var import_chunk_XX47T7HE = require("./chunk-XX47T7HE.js");
var import_chunk_5RIIWTW4 = require("./chunk-5RIIWTW4.js");
var import_chunk_DPKROP4G = require("./chunk-DPKROP4G.js");
var import_chunk_RS2R7COT = require("./chunk-RS2R7COT.js");
var import_chunk_5V36RLCO = require("./chunk-5V36RLCO.js");
var import_chunk_JE2YWM7K = require("./chunk-JE2YWM7K.js");
var import_chunk_HC6MILYB = require("./chunk-HC6MILYB.js");
var import_chunk_BLEP247V = require("./chunk-BLEP247V.js");
var import_chunk_JJ4ZA37O = require("./chunk-JJ4ZA37O.js");
var import_chunk_W4MUUWEL = require("./chunk-W4MUUWEL.js");
var import_chunk_Z7JJ2NRW = require("./chunk-Z7JJ2NRW.js");
var import_chunk_J77ZIDXB = require("./chunk-J77ZIDXB.js");
var import_chunk_PPKYE46G = require("./chunk-PPKYE46G.js");
var import_chunk_XR2ZRXE5 = require("./chunk-XR2ZRXE5.js");
var import_chunk_GACM5RDZ = require("./chunk-GACM5RDZ.js");
var import_chunk_CHY6NJBA = require("./chunk-CHY6NJBA.js");
var import_chunk_BHLFQQOC = require("./chunk-BHLFQQOC.js");
...
var import_chunk_6HJSACPK = require("./chunk-6HJSACPK.js");
var import_chunk_TCKAZCW5 = require("./chunk-TCKAZCW5.js");
var import_chunk_NAPCALUU = require("./chunk-NAPCALUU.js");
...
async function formatSchema({ schemaPath: schemaPath2, schema }, inputFormattingOptions) {
  ...
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_CHY6NJBA.prismaSchemaWasm.debug_panic();
      },
      { schemaPath: schemaPath2, schema }
    );
  }
  const schemaContent = (0, import_chunk_4CWLFPLE.N)({ schema, schemaPath: schemaPath2 }).when(isSchemaOnly, ({ schema: _schema }) => _schema).when(isSchemaPathOnly, ({ schemaPath: _schemaPath }) => {
  ...
  const { formattedSchema, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_PPKYE46G.lintSchema)({ schema: formattedSchema2 });
      return { formattedSchema: formattedSchema2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemaPath: schemaPath2, schema }
  );
  const lintWarnings = (0, import_chunk_PPKYE46G.getLintWarningsAsText)(lintDiagnostics);
  if (lintWarnings && import_chunk_NAPCALUU.logger_exports.should.warn()) {
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_CHY6NJBA.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
  return formattedSchema;
}
var import_p_map = (0, import_chunk_OQQ4P4PG.__toESM)((0, import_chunk_6HJSACPK.require_p_map)());
var debug = (0, import_debug3.default)("prisma:generator");
async function checkTypeScriptVersion() {
  const minVersion = "4.1.0";
  try {
    const typescriptPath = await (0, import_chunk_TCKAZCW5.resolvePkg)("typescript", {
      basedir: process.cwd()
    });
    ...
    if (typescriptPkg && import_fs5.default.existsSync(typescriptPkg)) {
      const pjson = (0, import_chunk_OQQ4P4PG.__require)(typescriptPkg);
      const currentVersion = pjson.version;
      if ((0, import_chunk_EUTJYQDW.semverLt)(currentVersion, minVersion)) {
        import_chunk_NAPCALUU.logger_exports.warn(
...
async function prismaClientResolver(baseDir2, version3) {
  let prismaClientDir = await (0, import_chunk_AZ66WJ3B.findPrismaClientDir)(baseDir2);
  ...
  if (!prismaClientDir && !process.env.PRISMA_GENERATE_SKIP_AUTOINSTALL) {
    ...
    const prismaCliDir = await (0, import_chunk_TCKAZCW5.resolvePkg)("prisma", { basedir: baseDir2 });
    if (process.platform === "win32" && await (0, import_chunk_2V53YI7V.isYarnUsed)(baseDir2)) {
      ...
      throw new Error(
        `Could not resolve ${missingCli(`${(0, import_chunk_DJGRU4RH.bold)("prisma")} and `)}${(0, import_chunk_DJGRU4RH.bold)(
          ...
          `${(0, import_chunk_DJGRU4RH.bold)((0, import_chunk_DJGRU4RH.green)(`${await (0, import_chunk_R5QZ4HCI.getPackageCmd)(baseDir2, "add", "prisma", "-D")}`))} and `
        )}${(0, import_chunk_DJGRU4RH.bold)((0, import_chunk_DJGRU4RH.green)(`${await (0, import_chunk_R5QZ4HCI.getPackageCmd)(baseDir2, "add", "@prisma/client")}`))}, and rerun ${(0, import_chunk_DJGRU4RH.bold)(
          await (0, import_chunk_R5QZ4HCI.getPackageCmd)(baseDir2, "execute", "prisma generate")
        )} \u{1F64F}.`
      );
    }
    if (!prismaCliDir) {
      await (0, import_chunk_RGLQVRDT.runPackageCmd)(projectRoot, "add", `prisma@${version3 ?? "latest"}`, "-D");
    }
    await (0, import_chunk_RGLQVRDT.runPackageCmd)(projectRoot, "add", `@prisma/client@${version3 ?? "latest"}`);
    prismaClientDir = await (0, import_chunk_AZ66WJ3B.findPrismaClientDir)(import_path2.default.join(".", baseDir2));
    if (!prismaClientDir) {
      throw new Error(
        `Could not resolve @prisma/client despite the installation that we just tried.
Please try to install it by hand with ${(0, import_chunk_DJGRU4RH.bold)(
          (0, import_chunk_DJGRU4RH.green)(`${await (0, import_chunk_R5QZ4HCI.getPackageCmd)(baseDir2, "add", "@prisma/client")}`)
        )} and rerun ${(0, import_chunk_DJGRU4RH.bold)(await (0, import_chunk_R5QZ4HCI.getPackageCmd)(baseDir2, "execute", "prisma generate"))} \u{1F64F}.`
      );
    }
    console.info(
      `
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_XR2ZRXE5.getConfig)({
    datamodel,
  ...
  if (config.datasources.length === 0) {
    throw new Error(import_chunk_HC6MILYB.missingDatasource);
  }
  ...
  const dmmf = await (0, import_chunk_GACM5RDZ.getDMMF)({
    datamodel,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
  ...
  if (dmmf.datamodel.models.length === 0) {
    if (config.datasources.some((d) => d.provider === "mongodb")) {
      throw new Error(import_chunk_BLEP247V.missingModelMessageMongoDB);
    }
    throw new Error(import_chunk_BLEP247V.missingModelMessage);
  }
...
`
    ...
    const binaryPathsByVersion = await (0, import_chunk_DPKROP4G.getBinaryPathsByVersion)({
      neededVersions,
      platform,
      version,
      printDownloadProgress,
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[platform]) {
          const customDmmf = await (0, import_chunk_GACM5RDZ.getDMMF)({
            datamodel,
            datamodelPath: schemaPath,
...
Please use the PRISMA_QUERY_ENGINE_BINARY env var instead to pin the binary target.`
    ...
    if (generator.binaryTargets) {
      ...
      const resolvedBinaryTargets = binaryTargets.flatMap((object) => (0, import_chunk_UJCWYERA.parseBinaryTargetsEnvValue)(object)).map((p) => p === "native" ? platform2 : p);
...
Possible binaryTargets: ${(0, import_chunk_DJGRU4RH.green)(knownBinaryTargets.join(", "))}`
      ...
      if (!resolvedBinaryTargets.includes(platform2)) {
        const originalBinaryTargetsConfig = (0, import_chunk_XX47T7HE.getOriginalBinaryTargetsValue)(generator.binaryTargets);
...
${(0, import_chunk_DJGRU4RH.green)(
          (0, import_chunk_XX47T7HE.printGeneratorConfig)({
            ...generator,
            binaryTargets: (0, import_chunk_5RIIWTW4.fixBinaryTargets)(generator.binaryTargets, platform2)
          })
        )}
...
More information about this limitation: ${(0, import_chunk_W4MUUWEL.link)("https://pris.ly/d/accelerate-limitations")}
`;
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  if (implicitSchema === true) {
    args["--schema"] = await (0, import_chunk_BHLFQQOC.getSchemaPath)(args["--schema"]) ?? void 0;
  }
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      (0, import_chunk_JJ4ZA37O.loadEnvFile)({ schemaPath: argValue, printMessage: false });
      const datamodel2 = await import_fs.default.promises.readFile(argValue, "utf-8");
      const config2 = await (0, import_chunk_XR2ZRXE5.getConfig)({ datamodel: datamodel2, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_XR2ZRXE5.resolveUrl)((0, import_chunk_XR2ZRXE5.getEffectiveUrl)(config2.datasources[0]));
