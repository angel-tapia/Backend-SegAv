...
var chunk_PNYSASZX_exports = {};
__export(chunk_PNYSASZX_exports, {
  getEngineVersion: () => getEngineVersion,
  safeGetEngineVersion: () => safeGetEngineVersion
});
module.exports = __toCommonJS(chunk_PNYSASZX_exports);
...
var import_execa = (0, import_chunk_OQQ4P4PG.__toESM)((0, import_chunk_DUMKIIDL.require_execa)());
async function getEngineVersion(enginePath, binaryName) {
  if (!binaryName) {
    binaryName = (0, import_engines.getCliQueryEngineBinaryType)();
  }
  enginePath = await (0, import_chunk_PGE3XZUY.resolveBinary)(binaryName, enginePath);
  ...
  if (binaryName === import_fetch_engine.BinaryType.QueryEngineLibrary) {
    ...
    const QE = (0, import_chunk_MELHV4JU.loadLibrary)(enginePath, platformInfo);
...
function safeGetEngineVersion(enginePath, binaryName) {
  return (0, import_chunk_ABB2542Q.tryCatch2)(
