...
var chunk_G2UXQVDZ_exports = {};
__export(chunk_G2UXQVDZ_exports, {
...
module.exports = __toCommonJS(chunk_G2UXQVDZ_exports);
...
var import_chunk_NPPGDQ3V = require("./chunk-NPPGDQ3V.js");
var import_chunk_IZYP2WFD = require("./chunk-IZYP2WFD.js");
var import_chunk_FMFUZIJH = require("./chunk-FMFUZIJH.js");
var import_chunk_PLXLXVHY = require("./chunk-PLXLXVHY.js");
...
async function formatSchema({ schemaPath: schemaPath2, schema }, inputFormattingOptions) {
  ...
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_PLXLXVHY.prismaSchemaWasm.debug_panic();
      },
  ...
  const { formattedSchema, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_NPPGDQ3V.lintSchema)({ schema: formattedSchema2 });
      return { formattedSchema: formattedSchema2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemaPath: schemaPath2, schema }
  );
  const lintWarnings = (0, import_chunk_NPPGDQ3V.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_PLXLXVHY.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_IZYP2WFD.getConfig)({
    datamodel,
  ...
  const dmmf = await (0, import_chunk_FMFUZIJH.getDMMF)({
    datamodel,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[platform]) {
          const customDmmf = await (0, import_chunk_FMFUZIJH.getDMMF)({
            datamodel,
            datamodelPath: schemaPath,
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_IZYP2WFD.getConfig)({ datamodel: datamodel2, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_IZYP2WFD.resolveUrl)((0, import_chunk_IZYP2WFD.getEffectiveUrl)(config2.datasources[0]));
