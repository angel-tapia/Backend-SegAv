...
var chunk_VBJ4ID6C_exports = {};
__export(chunk_VBJ4ID6C_exports, {
...
module.exports = __toCommonJS(chunk_VBJ4ID6C_exports);
...
async function execaCommand({
  ...
  schemaEnginePath = schemaEnginePath || await (0, import_chunk_PGE3XZUY.resolveBinary)(import_fetch_engine.BinaryType.SchemaEngineBinary);
  try {
