...
var chunk_NPPGDQ3V_exports = {};
__export(chunk_NPPGDQ3V_exports, {
...
module.exports = __toCommonJS(chunk_NPPGDQ3V_exports);
...
function lintSchema({ schema }) {
  const lintResult = import_chunk_PLXLXVHY.prismaSchemaWasm.lint(schema);
