...
var chunk_FMFUZIJH_exports = {};
__export(chunk_FMFUZIJH_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_FMFUZIJH_exports);
var import_chunk_ZWZY7GYQ = require("./chunk-ZWZY7GYQ.js");
var import_chunk_IEWN2IN7 = require("./chunk-IEWN2IN7.js");
...
[Context: getDmmf]`;
    super((0, import_chunk_IEWN2IN7.addVersionDetailsToErrorMessage)(errorMessageWithContext));
      ...
      return (0, import_function.pipe)(
        (0, import_chunk_ABB2542Q.tryCatch)(
          () => {
            ...
            const data = import_chunk_PLXLXVHY.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
