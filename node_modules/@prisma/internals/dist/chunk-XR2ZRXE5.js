...
var chunk_XR2ZRXE5_exports = {};
__export(chunk_XR2ZRXE5_exports, {
...
module.exports = __toCommonJS(chunk_XR2ZRXE5_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_ABB2542Q.tryCatch)(
      () => {
        ...
        const data = import_chunk_CHY6NJBA.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
