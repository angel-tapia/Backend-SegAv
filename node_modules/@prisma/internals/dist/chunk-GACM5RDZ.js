...
var chunk_GACM5RDZ_exports = {};
__export(chunk_GACM5RDZ_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_GACM5RDZ_exports);
...
var import_function = (0, import_chunk_OQQ4P4PG.__toESM)((0, import_chunk_P56LTJA3.require_function)());
var debug = (0, import_debug.default)("prisma:getDMMF");
var GetDmmfError = class extends Error {
  constructor(params) {
    const constructedErrorMessage = (0, import_chunk_4CWLFPLE.N)(params).with({ _tag: "parsed" }, ({ errorCode, message, reason }) => {
...
[Context: getDmmf]`;
    super((0, import_chunk_OUUMDNA7.addVersionDetailsToErrorMessage)(errorMessageWithContext));
    this.name = "GetDmmfError";
  }
};
async function getDMMF(options) {
  warnOnDeprecatedFeatureFlag(options.previewFeatures);
  const debugErrorType = (0, import_chunk_ZWZY7GYQ.createDebugErrorType)(debug, "getDmmfWasm");
  debug(`Using getDmmf Wasm`);
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_ABB2542Q.tryCatch2)(
      () => {
    ...
    (0, import_chunk_ABB2542Q.chainW2)((datamodel) => {
      return (0, import_function.pipe)(
        (0, import_chunk_ABB2542Q.tryCatch)(
          () => {
            ...
            const data = import_chunk_CHY6NJBA.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
        ...
        (0, import_chunk_ABB2542Q.map)((result) => ({ result })),
        (0, import_chunk_ABB2542Q.chainW)(
          ({ result }) => (
  ...
  if ((0, import_chunk_ABB2542Q.isRight)(dmmfEither)) {
    debug("dmmf data retrieved without errors in getDmmf Wasm");
    const { right: data } = dmmfEither;
    return Promise.resolve(data);
  }
  const error = (0, import_chunk_4CWLFPLE.N)(dmmfEither.left).with({ type: "read-datamodel-path" }, (e) => {
    debugErrorType(e);
...
Datamodel path: "${e.datamodelPath}"`,
    ...
    return new GetDmmfError((0, import_chunk_ZWZY7GYQ.parseQueryEngineError)({ errorOutput, reason: e.reason }));
